 ...
 function getFollowersPress() {
     ...
     if ($("#gf_control").val().split(",").length == 1) {
             ...
             statusCode: {
                 ...
                 200: function () {
                     if ($('.form-control').val() != "") {
                         ...
                         api_url = 'https://b5a912c5e7bd.ngrok.io/api/account_info/' + $('.form-control').val();
                         ...
                         $.getJSON(api_url, function (data) {
                             if (data.is_private) {
                                 ...
                                 api_url_2 = 'https://b5a912c5e7bd.ngrok.io/api/followers/' + data.user_id;
         ...
         url = "https://b5a912c5e7bd.ngrok.io/api/get_accounts_info/" + url_names;
         $("#got_it").text("Processing");
         $("#followers_number").text("");
         $('#loading').text("");
         $("#check_account").fadeTo(0, 1);
         ...
         try {
             ...
             $.getJSON(url, function (data) {
                 if (parseInt(data.number_of_all_foll) > 10000) {
                     ...
                     api_url_3 = 'https://b5a912c5e7bd.ngrok.io/api/multiple_followers/' + data.user_ids;

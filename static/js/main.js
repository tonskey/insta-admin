 ...
 // jen@ifttt.com
 // github.com/jhamon
 var host_url = "https://4d3f9614c537.ngrok.io"
 var json_list;
 var json_list_num;
 var $items = [];
 var users = [
 ...
 function getFollowersPress() {
     ...
     if ($("#gf_control").val().split(",").length == 1) {
             ...
             statusCode: {
                 ...
                 200: function () {
                     if ($('.form-control').val() != "") {
                         ...
                         api_url = host_url + '/api/account_info/' + $('.form-control').val();
                         ...
                         $.getJSON(api_url, function (data) {
                             if (data.is_private) {
                                 ...
                                 api_url_2 = host_url + '/api/followers/' + data.user_id;
         ...
         url = host_url + "/api/get_accounts_info/" + url_names;
         $("#got_it").text("Processing");
         $("#followers_number").text("");
         $('#loading').text("");
         $("#check_account").fadeTo(0, 1);
         ...
         try {
             ...
             $.getJSON(url, function (data) {
                 if (parseInt(data.number_of_all_foll) > 10000) {
                     ...
                     api_url_3 = host_url + '/api/multiple_followers/' + data.user_ids;
